...
const Title = styled.h2`
	...
	text-align: center;
	margin-bottom: 80px;
	background: linear-gradient(to right, #3c873a, #78b65d);
...
export const NodeIcon: React.FC = () => {
	return (
		<svg viewBox="0 0 448 512" style={{height: 70}}>
			<path
				fill="currentColor"
...
export const DockerIcon: React.FC = () => {
	return (
		<svg viewBox="0 0 640 512" style={{height: 70}}>
			<path
				fill="currentColor"
...
export const GithubIcon: React.FC = () => {
	return (
		<svg viewBox="0 0 496 512" style={{height: 70}}>
			<path
				fill="currentColor"
